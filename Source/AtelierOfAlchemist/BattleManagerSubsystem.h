...
public:
	...
	void StartBattle(AActor* PlayerActor, AActor* EnemyActor, const TArray<FEnemySpawnInfo>& InEnemyParty, UObject* WorldContextObject);
	...
	const TArray<FEnemySpawnInfo>& GetCurrentEnemyParty() const { return CurrentEnemyParty; }
...
protected:
	...
	UPROPERTY()
	TArray<FEnemySpawnInfo> CurrentEnemyParty;
